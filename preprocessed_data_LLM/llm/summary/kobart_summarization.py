...
if __name__ == "__main__":
    ...
    base_input_dir_1 = "./text/산업재"  # 산업재 입력 텍스트 파일들이 있는 디렉터리 경로
    base_output_dir_1 = "./summary/산업재"  # 요약 결과를 저장할 디렉터리 경로
    ...
    base_input_dir_2 = "./text/정보기술"  # 정보기술 입력 텍스트 디렉터리
    base_output_dir_2 = "./summary/정보기술"  # 정보기술 요약 저장 디렉터리
